        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl mb-8">
              ...
              <br />
              <br />
              I'm super interested in full-stack robotics, embedded firmware, and digital design, including ASIC and FPGA work. I've genuinely enjoyed every experience I've had in these spaces, and it's because they let me build things that can actually sense, think, and move on their own. That mix of innovation and real potential is what keeps me hooked!
            </p>
